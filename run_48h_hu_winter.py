#!/usr/bin/env python3
"""
48-hour optimization for Hungary (HU) in winter with full visualization.

Runs Model III optimization for 48 hours using HU winter market data,
...
from py_script.data.preprocessing import preprocess_market_data
...
def main():
    """Run 48h HU winter optimization and generate visualizations."""

    print("="*80)
    print("48-Hour Hungary Winter Optimization - Model III")
    print("="*80)
    ...
    try:
        ...
        # Extract winter period (48 hours)
        ...
        # Preprocess aFRR market data
        print("\n[OK] Preprocessing aFRR market data (replacing 0 prices with NaN)...")
        data_slice = preprocess_market_data(data_slice)
    ...
    csv_file = output_dir / f"solution_48h_hu_winter.csv"
    ...
    metadata_file = output_dir / f"solution_48h_hu_winter_metadata.json"
    import json
    ...
    plot_dir = output_dir / "hu_winter_48h_plots"
    plot_dir.mkdir(exist_ok=True, parents=True)

    title_suffix = f"(HU Winter, 48h)"
